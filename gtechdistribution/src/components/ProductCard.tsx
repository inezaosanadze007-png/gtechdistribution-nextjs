  ...
  return (
    <div className="hover-lift border border-line rounded-lg bg-surface overflow-hidden h-full flex flex-col">
      <div className="px-[18px] pt-6 pb-4 border-b border-line">
        <div className="inline-block font-mono text-[9.5px] text-accent border border-accentSoft bg-accentSoft rounded px-[7px] py-[3px] mb-3">
          {product.tag}
        </div>
      ...
      <div className="px-[18px] py-4 flex-1 flex flex-col">
        ...
        <div className="mt-auto">
          <button className="cta-btn w-full bg-accent text-bg rounded-md py-2 text-[11.5px] font-semibold">
            {quoteLabel}
          </button>
        </div>
      </div>
